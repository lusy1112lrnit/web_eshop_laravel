                            ...
                            <div class="position-relative row form-group">
                                ...
                                <div class="col-md-9 col-xl-8">
                                    <select required name="brand_id" id="brand_id" class="form-control">
                                        ...
                                        <option value="4" {{$product-> brand_id == 4 ? 'selected' : ''}}>Sony</option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="position-relative row form-group">
                                ...
                                <div class="col-md-9 col-xl-8">
                                    <select required name="product_category_id" id="product_category_id" class="form-control">
                                        ...
                                        <option value="1" {{$product->product_category_id == 1 ? 'selected' : ''}}>IOS</option>
                                        <option value="2" {{$product->product_category_id == 2 ? 'selected' : ''}}>Android</option>
                                        <option value="3" {{$product->product_category_id == 3 ? 'selected' : ''}}>WindownsPhone</option>
                                    </select>
                                </div>
                            </div>
