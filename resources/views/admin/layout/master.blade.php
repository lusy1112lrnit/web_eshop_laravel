...
<head>
    ...
    <title> @yield('title') | Admin_eShop</title>
    <meta name="viewport"
                                ...
                                <div class="widget-content-left">
                                    <div class="btn-group">
                                        <a data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"
                                            class="p-0 btn">
                                            <img width="42" class="rounded-circle" src="front/img/users/{{ Auth::user()->avatar ?? 'avatar-user.png' }}"
                                                alt="">
                                                            ...
                                                            <div class="widget-content-wrapper">
                                                                <div class="widget-content-left mr-3">
                                                                    <img width="42" class="rounded-circle"
                                                                        src="front/img/users/{{ Auth::user()->avatar ?? 'avatar-user.png' }}" alt="">
                                                                </div>
                                                                <div class="widget-content-left">
