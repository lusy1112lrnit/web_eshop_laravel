			...
			<div class="row">
				...
				<div class="col-md-5">
					<div class="product-details">
						...
						<div>
							...
							<a class="review-link" href="#"> Đánh Giá ({{count($product -> productComments)}}) | Thêm Đánh Giá</a>
						</div>
						<div>
							<h3 class="product-price">{{ number_format($product->discount, 0, ',', '.') }} VND <del class="product-old-price">{{ number_format($product->price, 0, ',', '.') }} VND</del></h3>
				...
				<div class="col-md-12">
					<div id="product-tab">
						<!-- product tab nav -->
						<ul class="tab-nav">
							<li class="active"><h3 style="color: brown">Chi tiết sản phẩm</h3></a></li>
